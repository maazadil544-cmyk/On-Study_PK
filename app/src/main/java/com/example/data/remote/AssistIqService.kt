...
object AssistIqService {
    ...
    // Fallback key provided directly by user for seamless prototype functionality
    private const val FALLBACK_API_KEY = "AQ.Ab8RN6KOwyNVPN9oYBE8wwK2wRdzXbrf5Ic9MZKD7l1CjVd3VA"
    ...
    fun getEffectiveApiKey(): String {
        ...
        return if (configKey.isNotBlank() && configKey != "MY_GEMINI_API_KEY") {
            configKey
        } else {
            FALLBACK_API_KEY
        }
